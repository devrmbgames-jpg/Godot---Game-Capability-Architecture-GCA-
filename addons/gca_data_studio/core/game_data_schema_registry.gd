...
const SCHEMAS: Dictionary = {
	&"GameAttributeDefinition": {
		...
		"columns": [
			...
			{"property": &"display_precision", "title": "Precision", "editable": true, "kind": &"int"},
	...
	&"GameMeterDefinition": {
		...
		"columns": [
			...
			{"property": &"minimum", "title": "Min", "editable": true, "kind": &"float"},
			{"property": &"maximum_change_policy", "title": "Max Change", "editable": true, "kind": &"enum", "options": ["Keep Current", "Keep Percentage", "Adjust By Delta", "Clamp Only"]},
	...
	&"GameEffectDefinition": {
		...
		"columns": [
			...
			{"property": &"required_target_tags", "title": "Required Tags", "editable": true, "kind": &"string_names"},
			{"property": &"blocked_target_tags", "title": "Blocked Tags", "editable": true, "kind": &"string_names"},
	...
	&"GameAbilityDefinition": {
		...
		"columns": [
			...
			{"property": &"display_name", "title": "Name", "editable": true, "kind": &"text"},
			{"property": &"ability_tags", "title": "Ability Tags", "editable": true, "kind": &"string_names"},
			{"property": &"required_owner_capabilities", "title": "Required Capabilities", "editable": true, "kind": &"string_names"},
			{"property": &"required_owner_tags", "title": "Required Tags", "editable": true, "kind": &"string_names"},
			{"property": &"blocked_owner_tags", "title": "Blocked Tags", "editable": true, "kind": &"string_names"},
			{"property": &"granted_tags_during_execution", "title": "Execution Tags", "editable": true, "kind": &"string_names"},
			...
			{"property": &"cooldown_groups", "title": "Cooldown Groups", "editable": true, "kind": &"string_names"},
			...
			{"property": &"retrigger_policy", "title": "Retrigger", "editable": true, "kind": &"enum", "options": ["Deny", "Restart", "Allow Parallel"]},
			...
			{"property": &"save_execution_policy", "title": "Save Execution", "editable": true, "kind": &"enum", "options": ["Cancel On Load", "Complete Before Save", "Disallow Save"]},
