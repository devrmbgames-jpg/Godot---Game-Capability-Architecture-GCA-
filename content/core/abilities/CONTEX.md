...
## Purpose
Data-driven ability ownership, activation, cost, cooldown, execution, cancellation, operation, and optional loadout contracts.
...
- `GameAbilityLoadout` maps logical slots to source-owned grant handles.
...
- Input actions map to logical slots; ability definitions never know physical buttons.
