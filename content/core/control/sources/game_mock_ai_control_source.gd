...
## Sends an ability activation intent with explicit targets and optional ability payload.
func use_ability(
	ability_id: StringName,
	target_handles: Array[GameObjectHandle],
	execution_context: GameExecutionContext,
